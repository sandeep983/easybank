...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        UserDetails user = User.withUsername("user").password("{noop}Tsw@12345").authorities("read").build();
        UserDetails admin = User.withUsername("admin")
                .password("{bcrypt}$2a$12$rDJSkT9lgMYERIDf64dLIOPF2sOcZwZ43xHzlakkqQbmcyrcu3YFy")
